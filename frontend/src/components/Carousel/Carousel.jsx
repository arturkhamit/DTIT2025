...
const DEFAULT_ITEMS = [
  {
    title: "How much time did I spend coding this month?",
    description: "",
    id: 1,
    icon: (
      <div>
  ...
  {
    title: "Hours rested this month",
    description: "",
    id: 3,
    icon: (
      <div>
        <CountUp from={0} to={67} duration={2.5} />
        <span className='countup-symbol'>h</span>
      </div>
    ),
  },
  {
        ...
        <div className='carousel-indicators'>
          {items.map((_, index) => (
            <motion.div
              ...
              animate={{
                scale:
                  currentIndex % items.length === index ? 1.2 : 1,
              }}
